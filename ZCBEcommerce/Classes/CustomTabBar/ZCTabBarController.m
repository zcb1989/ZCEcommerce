...
#define ZCColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0] //<<< 用10进制表示颜色，例如（255,255,255）黑色
...
//    //设置导航控制器颜色为黄色
//    [[UINavigationBar appearance] setBackgroundImage:[self imageWithColor:ZCColor(253, 218, 68)] forBarMetrics:UIBarMetricsDefault];
}
#pragma mark -
...
- (void)setUpChildViewController{
    ...
    [self addOneChildViewController:[[ZCBNavigationController alloc]initWithRootViewController:[[ZCMainViewController alloc]init]]
                          WithTitle:@"首页"
    ...
    [self addOneChildViewController:[[ZCBNavigationController alloc]initWithRootViewController:[[ZCMessageViewController alloc]init]]
                          WithTitle:@"消息"
...
- (void)addOneChildViewController:(UIViewController *)viewController WithTitle:(NSString *)title imageName:(NSString *)imageName selectedImageName:(NSString *)selectedImageName{
    ...
    viewController.view.backgroundColor     = ZCRandomColor;
